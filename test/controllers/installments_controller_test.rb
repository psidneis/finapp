...
class InstallmentsControllerTest < ActionController::TestCase
  ...
  test "should create installment" do
    assert_difference('Installment.count') do
      post :create, installment: { date: @installment.date, launch_id: @installment.launch_id, number_installment: @installment.number_installment, paid: @installment.paid, value: @installment.value }
    end
  ...
  test "should update installment" do
    patch :update, id: @installment, installment: { date: @installment.date, launch_id: @installment.launch_id, number_installment: @installment.number_installment, paid: @installment.paid, value: @installment.value }
    assert_redirected_to installment_path(assigns(:installment))
  end
